...
import net.aakil.jhipster.store.repository.CustomerRepository;
import net.aakil.jhipster.store.service.CustomerService;
...
import net.aakil.jhipster.store.domain.enumeration.Gender;
/**
