...
import net.aakil.jhipster.store.domain.OrderItem;
import net.aakil.jhipster.store.service.OrderItemService;
...
/**
 * REST controller for managing {@link net.aakil.jhipster.store.domain.OrderItem}.
 */
@RestController
@RequestMapping("/api")
