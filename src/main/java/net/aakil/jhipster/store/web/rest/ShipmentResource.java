...
import net.aakil.jhipster.store.domain.Shipment;
import net.aakil.jhipster.store.service.ShipmentService;
...
/**
 * REST controller for managing {@link net.aakil.jhipster.store.domain.Shipment}.
 */
@RestController
@RequestMapping("/api")
